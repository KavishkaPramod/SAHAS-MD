...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "pPFBDY5R#QnYz8pi_9ZNwDwoMUV-NmpiiBS8Zw25NulyJ8LPWoDw",
  // ADD Your Session Id 
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "923247116683",
  //========================================- OTHER - CONFIGS -=====================================================================
  ...
  packname: process.env.packname || "ZiDi TECH",
  author: process.env.author || "ZiDi TECH",
  //==========================================- API-CONFIGS -==========================================================
